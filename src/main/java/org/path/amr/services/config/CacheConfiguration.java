...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, org.path.amr.services.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, org.path.amr.services.repository.UserRepository.USERS_BY_EMAIL_CACHE);
